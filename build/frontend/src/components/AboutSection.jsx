  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Vebhor is a next‑generation Workforce Enablement Services company that helps enterprises build, manage, & scale global teams{' '}
          <strong style={{ color: 'rgb(40, 129, 251)', fontWeight: 700 }}>precision</strong>,{' '}
          <strong style={{ color: '#00c9a7', fontWeight: 700 }}>compliance</strong>, &{' '}
          <strong style={{ color: 'rgb(40, 129, 251)', fontWeight: 700 }}>AI‑driven efficiency</strong>. With deep expertise across talent management, payrolling, contractor operations, & global mobility, we deliver industry‑specific solutions that meet the complex workforce needs of modern businesses. tailored workforce strategies, transparent operations, & end‑to‑end execution.
        </p>
