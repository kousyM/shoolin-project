  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <span style={{ color: '#E11D48', fontWeight: 800 }}>Get started in 1 hour</span> with Shoolin’s<br />
                ...
                >
                  ...
                  <div
                    style={{
                      ...
                      height: '42px',
                      borderRadius: '50%',
                      border: isPastOrActive ? '2.5px solid #E11D48' : '2px solid #FECDD3',
                      background: isPastOrActive ? 'linear-gradient(135deg, #E11D48 0%, #BE123C 100%)' : '#ffffff',
                      color: isPastOrActive ? '#ffffff' : '#E11D48',
                      fontWeight: 800,
                      fontSize: '1rem',
                      display: 'flex',
                      alignItems: 'center',
                      ...
                      marginBottom: '1.5rem',
                      boxShadow: isCurrent
                        ? '0 0 0 7px rgba(225, 29, 72, 0.2), 0 8px 24px rgba(225, 29, 72, 0.45)'
                        : isPastOrActive
        ...
        <div style={{ textAlign: 'center' }}>
          <a
            ...
            onMouseEnter={(e) => {
              ...
              e.currentTarget.style.boxShadow = '0 12px 30px rgba(225, 29, 72, 0.5)';
            }}
            onMouseLeave={(e) => {
              e.currentTarget.style.transform = 'translateY(0)';
              e.currentTarget.style.boxShadow = '0 8px 24px rgba(225, 29, 72, 0.35)';
            }}
          >
            <span>Start Now</span>
            <ArrowRight size={18} />
