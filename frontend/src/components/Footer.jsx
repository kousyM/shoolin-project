          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
            ...
            <div style={{ display: 'flex', gap: '0.5rem' }}>
              ...
              <a
                ...
                onMouseEnter={(e) => { e.currentTarget.style.backgroundColor = 'rgb(2, 41, 176)'; e.currentTarget.style.color = '#ffffff'; }}
      ...
      <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '1.15rem 1.5rem', display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between', alignItems: 'center', gap: '1rem', fontSize: '0.9rem', color: '#475569' }}>
        ...
        <div style={{ display: 'flex', gap: '1.5rem', alignItems: 'center', fontSize: '0.9rem' }}>
          <a
            ...
            onMouseEnter={(e) => e.currentTarget.style.color = 'rgb(2, 41, 176)'}
