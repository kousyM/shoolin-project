      ...
      <main>
        ...
        >
          <div style={{ maxWidth: '1240px', margin: '0 auto', position: 'relative', zIndex: 2 }}>
            ...
            >
              <span style={{ fontSize: '0.85rem', fontWeight: 800, textTransform: 'uppercase', letterSpacing: '0.14em', color: '#E11D48', display: 'inline-block', marginBottom: '1.25rem' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(340px, 1fr))', gap: '2.5rem' }}>
              ...
              >
                <div style={{ width: '56px', height: '56px', borderRadius: '16px', backgroundColor: '#eff6ff', border: '1px solid #bfdbfe', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#E11D48', marginBottom: '2rem' }}>
                  <Building2 size={28} />
                </div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column' }}>
                {[
                  ...
                  return (
                    ...
                    >
                      <div style={{ color: '#E11D48', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
