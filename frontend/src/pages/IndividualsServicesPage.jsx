      ...
      <main>
        ...
        >
          ...
          <div style={{ maxWidth: '1280px', width: '100%', margin: '0 auto', position: 'relative', zIndex: 3 }}>
            <div style={{ maxWidth: '580px' }}>
              ...
              >
                Shoolin helps individuals, professionals, and families navigate the complexities of global visas, work permits, residency, and citizenship worldwide.
              </p>
        ...
        <section style={{ padding: '6rem 2rem', backgroundColor: '#f8fafc', position: 'relative', borderBottom: '1px solid #e2e8f0' }}>
          <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
            ...
            >
              <h2 style={{ fontFamily: "var(--bs-body-font-family), 'Outfit', sans-serif", fontSize: '2.5rem', fontWeight: 800, color: '#E11D48', marginBottom: '1.25rem', lineHeight: 1.2 }}>
              ...
              <p style={{ fontSize: '1.25rem', fontWeight: 700, color: '#0f172a', marginBottom: '1.75rem', lineHeight: 1.5 }}>
                Shoolin helps individuals and families navigate the complexities of immigration, residency and citizenship worldwide.
              </p>
            ...
            <div style={{ marginTop: '1rem' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '1.5rem' }}>
                ...
                >
                  <div style={{ width: '52px', height: '52px', borderRadius: '14px', backgroundColor: '#eff6ff', color: '#E11D48', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '1.35rem' }}>
                    <Compass size={28} />
                  </div>
