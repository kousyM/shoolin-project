          ...
          {loading ? (
            ...
            <div style={{ padding: '4rem 2rem', textAlign: 'center', color: '#64748b', backgroundColor: '#f8fafc', borderRadius: '16px', border: '1.5px solid #e2e8f0' }}>
              ...
              <button
                ...
                style={{ marginTop: '1rem', padding: '0.6rem 1.5rem', background: 'linear-gradient(135deg, #E11D48 0%, #BE123C 100%)', color: '#ffffff', border: 'none', borderRadius: '8px', cursor: 'pointer', fontWeight: 700 }}
              >
                Reset Filters
              </button>
            </div>
                ...
                >
                  ...
                  <div>
                    ...
                    >
                      ...
                      <span style={{ color: '#E11D48', fontWeight: 600 }}>{job.department}</span>
                      {job.is_remote && (
              ...
              >
                ...
                <div>
                  ...
                  <input
                    ...
                    onFocus={(e) => (e.target.style.borderBottomColor = '#E11D48')}
            ...
            {eoiStatus.success ? (
              <div style={{ padding: '2rem 1rem', textAlign: 'center' }}>
                ...
                <button
                  ...
                  style={{ padding: '0.75rem 1.5rem', background: 'linear-gradient(135deg, #E11D48 0%, #BE123C 100%)', color: '#ffffff', borderRadius: '50px', fontWeight: 700, border: 'none', cursor: 'pointer', boxShadow: '0 4px 15px rgba(2, 41, 176, 0.45)' }}
                >
                  Close
                </button>
              </div>
              ...
              <form onSubmit={handleEoiSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.1rem' }}>
                ...
                <button
                  ...
                  style={{ marginTop: '0.5rem', padding: '0.85rem', background: 'linear-gradient(135deg, #E11D48 0%, #BE123C 100%)', color: '#ffffff', fontWeight: 800, fontSize: '0.95rem', borderRadius: '50px', border: 'none', cursor: 'pointer', boxShadow: '0 4px 15px rgba(2, 41, 176, 0.45)' }}
                >
