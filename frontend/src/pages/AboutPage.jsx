  ...
  return (
    <div style={{ backgroundColor: '#ffffff', minHeight: '100vh', fontFamily: "var(--bs-body-font-family), 'Plus Jakarta Sans', sans-serif" }}>
      ...
      <main style={{ paddingTop: 0, marginTop: 0 }}>
        ...
        {/* ============================================================ */}
        {/* 5. WHY CLIENTS WORK WITH US SECTION (ANIMATED CARDS) */}
        {/* ============================================================ */}
        <section
          ref={clientsRef}
          style={{
        ...
        >
          <div style={{ maxWidth: '1180px', margin: '0 auto' }}>
            ...
            <div>
              ...
              >
                <span style={{ fontSize: '0.82rem', fontWeight: 800, textTransform: 'uppercase', letterSpacing: '0.12em', color: '#ffffff', backgroundColor: '#6C5CE7', padding: '0.4rem 1.4rem', borderRadius: '18px 24px 24px 18px', display: 'inline-block', marginBottom: '1.25rem', boxShadow: '0 4px 14px rgba(108, 92, 231, 0.35)' }}>
                  CLIENT ADVANTAGE
                </span>
