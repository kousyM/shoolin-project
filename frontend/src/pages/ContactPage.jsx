      ...
      <main>
        ...
        <div style={{ backgroundColor: '#ffffff' }}>
          <ContactSection
            ...
            subtitle="Fill out the form below and a Shoolin representative will contact you shortly."
          />
        </div>
                ...
                return (
                  <div
                    ...
                    style={{
                      ...
                      border: isSelected ? '2.5px solid #E11D48' : '1px solid rgba(255, 255, 255, 0.12)',
                      ...
                      <div style={{ display: 'flex', justifyContent: 'flex-end' }}>
                        <div
                          style={{
                            ...
                            height: '36px',
                            borderRadius: '50%',
                            background: isSelected ? 'linear-gradient(135deg, #E11D48 0%, #BE123C 100%)' : 'rgba(15, 23, 42, 0.9)',
                            color: '#ffffff',
                            display: 'flex',
                            alignItems: 'center',
                            justifyContent: 'center',
